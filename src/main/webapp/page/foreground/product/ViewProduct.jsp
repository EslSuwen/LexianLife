            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <ul class="list-unstyled list-inline">
                        <c:forEach items="${requestScope.viewCategory.catalog.categories}" var="category"
                                   varStatus="status">
                                        ...
                                        <div class="productItem" onmouseenter="mouseInProductItem(this)"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6"><span
                                                        class="price">￥${requestScope.page.getContent()[status.index].unitPrice}</span>
                                                </div>
                                                <div class="col-md-6"><span
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="concernBox"
                                                         id="con${requestScope.page.getContent()[status.index].goodsId}"
                                                         onmouseenter="concernIn(this,'${requestScope.page.getContent()[status.index].goodsId}')"
                                                         onmouseleave="concernOut(this,'${requestScope.page.getContent()[status.index].goodsId}')">
                                                        <div class="row">
                                                            <div class="col-md-3"><img src="../../../img/concern1.png"
                                                                                       class="concern"
                                                                                       id="${requestScope.page.getContent()[status.index].goodsId}">
                                                            </div>
                                                            <div class="col-md-9"><a href="javascript:void(0)"
                                                                                     class="concernText"
                                                                                     onclick="addAttention('${requestScope.page.getContent()[status.index].goodsId}')">关注</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <c:if test="${requestScope.page.getContent()[status.index+1]!=null}">
                                        <td>
                                            <div class="productItem" onmouseenter="mouseInProductItem(this)"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"><span
                                                            class="price">￥${requestScope.page.getContent()[status.index+1].unitPrice}</span>
                                                    </div>
                                                    <div class="col-md-6"><span
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="concernBox"
                                                             id="con${requestScope.page.getContent()[status.index+1].goodsId}"
                                                             onmouseenter="concernIn(this,'${requestScope.page.getContent()[status.index+1].goodsId}')"
                                                             onmouseleave="concernOut(this,'${requestScope.page.getContent()[status.index+1].goodsId}')">
                                                            <div class="row">
                                                                <div class="col-md-3"><img
                                                                        src="../../../img/concern1.png" class="concern"
                                                                        id="${requestScope.page.getContent()[status.index+1].goodsId}">
                                                                </div>
                                                                <div class="col-md-9"><a href="javascript:void(0)"
                                                                                         class="concernText"
                                                                                         onclick="addAttention('${requestScope.page.getContent()[status.index+1].goodsId}')">关注</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <c:if test="${requestScope.page.getContent()[status.index+2]!=null}">
                                        <td>
                                            <div class="productItem" onmouseenter="mouseInProductItem(this)"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"><span
                                                            class="price">￥${requestScope.page.getContent()[status.index+2].unitPrice}</span>
                                                    </div>
                                                    <div class="col-md-6"><span
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="concernBox"
                                                             id="con${requestScope.page.getContent()[status.index+2].goodsId}"
                                                             onmouseenter="concernIn(this,'${requestScope.page.getContent()[status.index+2].goodsId}')"
                                                             onmouseleave="concernOut(this,'${requestScope.page.getContent()[status.index+2].goodsId}')">
                                                            <div class="row">
                                                                <div class="col-md-3"><img
                                                                        src="../../../img/concern1.png" class="concern"
                                                                        id="${requestScope.page.getContent()[status.index+2].goodsId}">
                                                                </div>
                                                                <div class="col-md-9"><a href="javascript:void(0)"
                                                                                         class="concernText"
                                                                                         onclick="addAttention('${requestScope.page.getContent()[status.index+2].goodsId}')">关注</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <c:if test="${requestScope.page.getContent()[status.index+3]!=null}">
                                        <td>
                                            <div class="productItem" onmouseenter="mouseInProductItem(this)"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6"><span
                                                            class="price">￥${requestScope.page.getContent()[status.index+3].unitPrice}</span>
                                                    </div>
                                                    <div class="col-md-6"><span
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="concernBox"
                                                             id="con${requestScope.page.getContent()[status.index+3].goodsId}"
                                                             onmouseenter="concernIn(this,'${requestScope.page.getContent()[status.index+3].goodsId}')"
                                                             onmouseleave="concernOut(this,'${requestScope.page.getContent()[status.index+3].goodsId}')">
                                                            <div class="row">
                                                                <div class="col-md-3"><img
                                                                        src="../../../img/concern1.png" class="concern"
                                                                        id="${requestScope.page.getContent()[status.index+3].goodsId}">
                                                                </div>
                                                                <div class="col-md-9"><a href="javascript:void(0)"
                                                                                         class="concernText"
                                                                                         onclick="addAttention('${requestScope.page.getContent()[status.index+3].goodsId}')">关注</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
