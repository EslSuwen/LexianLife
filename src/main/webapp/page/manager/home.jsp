...
<div class="page-content clearfix">
    ...
    <div class="clearfix">
        <div class="home_btn">
            <div>
                <a href="/admin/product/product_add" title="添加商品" class="btn  btn-info btn-sm no-radius">
                    <i class="bigger-200"><img src="../../img/manager/icon-addp.png"/></i>
                    <h5 class="margin-top">添加商品</h5>
                </a>
                <a href="/admin/product/category" title="产品分类" class="btn  btn-primary btn-sm no-radius">
                    <i class="bigger-200"><img src="../../img/manager/icon-cpgl.png"/></i>
                    <h5 class="margin-top">产品分类</h5>
                </a>
                <a href="/admin/admin_info" title="个人信息" class="btn  btn-success btn-sm no-radius">
                    <i class="bigger-200"><img src="../../img/manager/icon-grxx.png"/></i>
                    <h5 class="margin-top">个人信息</h5>
                </a>
                <a href="/admin/order/order_handling" title="商品订单" class="btn  btn-purple btn-sm no-radius">
