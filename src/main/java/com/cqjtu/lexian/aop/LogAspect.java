...
/**
 * LogAspect @Description: 日志记录AOP实现
 *
 * @author shaojian.yu
...
public class LogAspect {
   ...
   * @param joinPoint
   */
  @Before("execution(* com.cqjtu.lexian.controller.*..*.*(..))")
   ...
   * @param joinPoint
   */
  @After("execution(* com.cqjtu.lexian.controller.*..*.*(..))")
  ...
  public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
    ...
    // 从session中获取用户信息
    Customer loginInfo = (Customer) request.getSession().getAttribute("customer");
    if (loginInfo != null) {
